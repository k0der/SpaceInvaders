...
/**
 * Create reactive-optimized AI decision state.
 */
export function createReactiveOptimizedState() {
  return {};
}
...
/**
 * Update reactive-optimized AI control flags on aiShip to pursue targetShip,
 ...
 */
export function updateReactiveOptimizedAI(
  _aiState,
  aiShip,
  targetShip,
  asteroids,
...
/**
 * Reactive-optimized AI strategy object — pluggable interface.
 */
export const reactiveOptimizedStrategy = {
  createState: createReactiveOptimizedState,
  update: updateReactiveOptimizedAI,
};

// Self-register in the strategy registry
registerStrategy('reactive-optimized', reactiveOptimizedStrategy);
