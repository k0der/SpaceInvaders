...
- **Highest priority next fix**: Multi-lever combination — DANGER_ZONE_BASE_PENALTY=-10000 (or -12000) + HYSTERESIS_BONUS increase to 350-400. HYSTERESIS_BONUS alone is counterproductive (Cycle 3: +75% oscillation), but as a targeted damper for proximity-zone score volatility alongside a DZPB reduction it may absorb the oscillation without causing commitment errors. Alternatively, explore AIM_BONUS increase as a different mechanism to shift aim/evasion balance.
