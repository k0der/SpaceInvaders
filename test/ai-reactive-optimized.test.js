...
import {
  ...
  createReactiveOptimizedState,
  FIRE_ANGLE,
  MAX_FIRE_RANGE,
  MAX_PREDICTION_TIME,
  PREDICTION_SPEED,
  ROTATION_DEADZONE,
  reactiveOptimizedStrategy,
  THRUST_ANGLE,
  updateReactiveOptimizedAI,
} from '../src/ai-reactive-optimized.js';
import { createShip, updateShip } from '../src/ship.js';

describe('ai-reactive-optimized: Strategy interface', () => {
  it('reactiveOptimizedStrategy has createState and update methods', () => {
    expect(typeof reactiveOptimizedStrategy.createState).toBe('function');
    expect(typeof reactiveOptimizedStrategy.update).toBe('function');
  });

  it('createState returns the same as createReactiveOptimizedState', () => {
    const state = reactiveOptimizedStrategy.createState();
    expect(typeof state).toBe('object');
    expect(state).not.toBeNull();
  });

  it('update is the same as updateReactiveOptimizedAI', () => {
    expect(reactiveOptimizedStrategy.update).toBe(updateReactiveOptimizedAI);
  });
});

describe('ai-reactive-optimized: Constants', () => {
...
describe('ai-reactive-optimized: createReactiveOptimizedState', () => {
  it('returns an object', () => {
    const state = createReactiveOptimizedState();
    expect(typeof state).toBe('object');
    expect(state).not.toBeNull();
  });
});

describe('ai-reactive-optimized: updateReactiveOptimizedAI — rotation toward target', () => {
  it('does not rotate when target is directly ahead (within deadzone)', () => {
    ...
    updateReactiveOptimizedAI(state, ai, target, [], 0.016);
...
describe('ai-reactive-optimized: updateReactiveOptimizedAI — thrust', () => {
...
describe('ai-reactive-optimized: updateReactiveOptimizedAI — braking', () => {
...
describe('ai-reactive-optimized: updateReactiveOptimizedAI — dead ship handling', () => {
...
describe('ai-reactive-optimized: updateReactiveOptimizedAI — target prediction (lead aiming)', () => {
...
describe('ai-reactive-optimized: AI ship uses same physics as player', () => {
  it('AI-controlled ship accelerates via updateShip after updateReactiveOptimizedAI sets thrust', () => {
    const ai = createShip({ x: 0, y: 0, heading: 0, owner: 'enemy' });
    const target = createShip({ x: 500, y: 0, heading: 0, owner: 'player' });
    const state = createReactiveOptimizedState();
...
describe('ai-reactive-optimized: updateReactiveOptimizedAI — firing', () => {
...
describe('ai-reactive-optimized: computeAvoidanceOffset', () => {
...
describe('ai-reactive-optimized: computeAvoidanceOffset — proximity detection', () => {
...
describe('ai-reactive-optimized: computeAvoidanceOffset — velocity-based prediction', () => {
...
describe('ai-reactive-optimized: updateReactiveOptimizedAI — avoidance integration', () => {
  it('steers away from asteroid directly ahead on collision course', () => {
    ...
    updateReactiveOptimizedAI(state, ai, target, asteroids, 0.016);
